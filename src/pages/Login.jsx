        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4 w-full">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-medium text-foreground flex justify-between">
              Password
              <a href="#" className="text-primary text-xs hover:underline font-normal">Forgot?</a>
            </label>
            <input
              type="password"
              name="password"
          ...
          <button 
            type="submit"
            disabled={loading}
            className="mt-1 p-2.5 rounded-md bg-primary hover:bg-primary/90 text-primary-foreground font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
          >
